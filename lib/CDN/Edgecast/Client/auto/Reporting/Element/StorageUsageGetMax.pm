...
package CDN::Edgecast::Client::auto::Reporting::Element::StorageUsageGetMax;
BEGIN {
  $CDN::Edgecast::Client::auto::Reporting::Element::StorageUsageGetMax::VERSION = '0.01.00';
}
use strict;
use warnings;
...
CDN::Edgecast::Client::auto::Reporting::Element::StorageUsageGetMax
...
=head2 new
 ...
 my $element = CDN::Edgecast::Client::auto::Reporting::Element::StorageUsageGetMax->new($data);
