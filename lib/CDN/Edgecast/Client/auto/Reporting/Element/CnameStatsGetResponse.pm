...
package CDN::Edgecast::Client::auto::Reporting::Element::CnameStatsGetResponse;
BEGIN {
  $CDN::Edgecast::Client::auto::Reporting::Element::CnameStatsGetResponse::VERSION = '0.01.00';
}
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'CnameStatsGetResult' => 'CDN::Edgecast::Client::auto::Reporting::Type::Cnames',
    },
    {
...
CDN::Edgecast::Client::auto::Reporting::Element::CnameStatsGetResponse
...
=head2 new
 ...
 my $element = CDN::Edgecast::Client::auto::Reporting::Element::CnameStatsGetResponse->new($data);
