...
package CDN::Edgecast::Client::auto::Reporting::Element::CacheStatusStatsGet;
BEGIN {
  $CDN::Edgecast::Client::auto::Reporting::Element::CacheStatusStatsGet::VERSION = '0.01.00';
}
use strict;
use warnings;
...
CDN::Edgecast::Client::auto::Reporting::Element::CacheStatusStatsGet
...
=head2 new
 ...
 my $element = CDN::Edgecast::Client::auto::Reporting::Element::CacheStatusStatsGet->new($data);
