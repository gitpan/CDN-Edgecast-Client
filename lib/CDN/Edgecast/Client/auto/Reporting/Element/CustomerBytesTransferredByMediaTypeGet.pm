...
package CDN::Edgecast::Client::auto::Reporting::Element::CustomerBytesTransferredByMediaTypeGet;
BEGIN {
  $CDN::Edgecast::Client::auto::Reporting::Element::CustomerBytesTransferredByMediaTypeGet::VERSION = '0.01.00';
}
use strict;
use warnings;
...
CDN::Edgecast::Client::auto::Reporting::Element::CustomerBytesTransferredByMediaTypeGet
...
=head2 new
 ...
 my $element = CDN::Edgecast::Client::auto::Reporting::Element::CustomerBytesTransferredByMediaTypeGet->new($data);
