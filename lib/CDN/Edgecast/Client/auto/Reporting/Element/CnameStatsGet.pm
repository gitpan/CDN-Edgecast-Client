...
package CDN::Edgecast::Client::auto::Reporting::Element::CnameStatsGet;
BEGIN {
  $CDN::Edgecast::Client::auto::Reporting::Element::CnameStatsGet::VERSION = '0.01.00';
}
use strict;
use warnings;
...
CDN::Edgecast::Client::auto::Reporting::Element::CnameStatsGet
...
=head2 new
 ...
 my $element = CDN::Edgecast::Client::auto::Reporting::Element::CnameStatsGet->new($data);
