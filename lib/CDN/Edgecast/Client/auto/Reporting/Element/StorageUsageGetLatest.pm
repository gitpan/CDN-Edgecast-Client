...
package CDN::Edgecast::Client::auto::Reporting::Element::StorageUsageGetLatest;
BEGIN {
  $CDN::Edgecast::Client::auto::Reporting::Element::StorageUsageGetLatest::VERSION = '0.01.00';
}
use strict;
use warnings;
...
CDN::Edgecast::Client::auto::Reporting::Element::StorageUsageGetLatest
...
=head2 new
 ...
 my $element = CDN::Edgecast::Client::auto::Reporting::Element::StorageUsageGetLatest->new($data);
