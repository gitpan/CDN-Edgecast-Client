...
package CDN::Edgecast::Client::auto::Reporting::Element::DirStatsGet;
BEGIN {
  $CDN::Edgecast::Client::auto::Reporting::Element::DirStatsGet::VERSION = '0.01.00';
}
use strict;
use warnings;
...
CDN::Edgecast::Client::auto::Reporting::Element::DirStatsGet
...
=head2 new
 ...
 my $element = CDN::Edgecast::Client::auto::Reporting::Element::DirStatsGet->new($data);
