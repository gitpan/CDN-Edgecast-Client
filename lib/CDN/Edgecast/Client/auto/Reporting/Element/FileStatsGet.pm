...
package CDN::Edgecast::Client::auto::Reporting::Element::FileStatsGet;
BEGIN {
  $CDN::Edgecast::Client::auto::Reporting::Element::FileStatsGet::VERSION = '0.01.00';
}
use strict;
use warnings;
...
CDN::Edgecast::Client::auto::Reporting::Element::FileStatsGet
...
=head2 new
 ...
 my $element = CDN::Edgecast::Client::auto::Reporting::Element::FileStatsGet->new($data);
