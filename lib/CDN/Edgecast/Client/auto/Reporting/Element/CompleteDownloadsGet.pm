...
package CDN::Edgecast::Client::auto::Reporting::Element::CompleteDownloadsGet;
BEGIN {
  $CDN::Edgecast::Client::auto::Reporting::Element::CompleteDownloadsGet::VERSION = '0.01.00';
}
use strict;
use warnings;
...
CDN::Edgecast::Client::auto::Reporting::Element::CompleteDownloadsGet
...
=head2 new
 ...
 my $element = CDN::Edgecast::Client::auto::Reporting::Element::CompleteDownloadsGet->new($data);
