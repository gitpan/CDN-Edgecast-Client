...
package CDN::Edgecast::Client::auto::MediaManager::Element::WmsPubPointDelete;
BEGIN {
  $CDN::Edgecast::Client::auto::MediaManager::Element::WmsPubPointDelete::VERSION = '0.01.00';
}
use strict;
use warnings;
...
CDN::Edgecast::Client::auto::MediaManager::Element::WmsPubPointDelete
...
=head2 new
 ...
 my $element = CDN::Edgecast::Client::auto::MediaManager::Element::WmsPubPointDelete->new($data);
