...
package CDN::Edgecast::Client::auto::MediaManager::Element::TokenKeyUpdate;
BEGIN {
  $CDN::Edgecast::Client::auto::MediaManager::Element::TokenKeyUpdate::VERSION = '0.01.00';
}
use strict;
use warnings;
...
CDN::Edgecast::Client::auto::MediaManager::Element::TokenKeyUpdate
...
=head2 new
 ...
 my $element = CDN::Edgecast::Client::auto::MediaManager::Element::TokenKeyUpdate->new($data);
