...
package CDN::Edgecast::Client::auto::MediaManager::Element::FmsLiveAuthGlobalKeyGet;
BEGIN {
  $CDN::Edgecast::Client::auto::MediaManager::Element::FmsLiveAuthGlobalKeyGet::VERSION = '0.01.00';
}
use strict;
use warnings;
...
CDN::Edgecast::Client::auto::MediaManager::Element::FmsLiveAuthGlobalKeyGet
...
=head2 new
 ...
 my $element = CDN::Edgecast::Client::auto::MediaManager::Element::FmsLiveAuthGlobalKeyGet->new($data);
