...
package CDN::Edgecast::Client::auto::MediaManager::Element::FmsLiveAuthStreamKeyDelete;
BEGIN {
  $CDN::Edgecast::Client::auto::MediaManager::Element::FmsLiveAuthStreamKeyDelete::VERSION = '0.01.00';
}
use strict;
use warnings;
...
CDN::Edgecast::Client::auto::MediaManager::Element::FmsLiveAuthStreamKeyDelete
...
=head2 new
 ...
 my $element = CDN::Edgecast::Client::auto::MediaManager::Element::FmsLiveAuthStreamKeyDelete->new($data);
