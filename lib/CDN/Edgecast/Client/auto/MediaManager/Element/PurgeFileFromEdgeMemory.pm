...
package CDN::Edgecast::Client::auto::MediaManager::Element::PurgeFileFromEdgeMemory;
BEGIN {
  $CDN::Edgecast::Client::auto::MediaManager::Element::PurgeFileFromEdgeMemory::VERSION = '0.01.00';
}
use strict;
use warnings;
...
CDN::Edgecast::Client::auto::MediaManager::Element::PurgeFileFromEdgeMemory
...
=head2 new
 ...
 my $element = CDN::Edgecast::Client::auto::MediaManager::Element::PurgeFileFromEdgeMemory->new($data);
