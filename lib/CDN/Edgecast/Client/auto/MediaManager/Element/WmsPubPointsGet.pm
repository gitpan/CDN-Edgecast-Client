...
package CDN::Edgecast::Client::auto::MediaManager::Element::WmsPubPointsGet;
BEGIN {
  $CDN::Edgecast::Client::auto::MediaManager::Element::WmsPubPointsGet::VERSION = '0.01.00';
}
use strict;
use warnings;
...
CDN::Edgecast::Client::auto::MediaManager::Element::WmsPubPointsGet
...
=head2 new
 ...
 my $element = CDN::Edgecast::Client::auto::MediaManager::Element::WmsPubPointsGet->new($data);
