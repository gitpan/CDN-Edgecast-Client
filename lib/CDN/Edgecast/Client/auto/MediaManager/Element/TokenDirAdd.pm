...
package CDN::Edgecast::Client::auto::MediaManager::Element::TokenDirAdd;
BEGIN {
  $CDN::Edgecast::Client::auto::MediaManager::Element::TokenDirAdd::VERSION = '0.01.00';
}
use strict;
use warnings;
...
CDN::Edgecast::Client::auto::MediaManager::Element::TokenDirAdd
...
=head2 new
 ...
 my $element = CDN::Edgecast::Client::auto::MediaManager::Element::TokenDirAdd->new($data);
