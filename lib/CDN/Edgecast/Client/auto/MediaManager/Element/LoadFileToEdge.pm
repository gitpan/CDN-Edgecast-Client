...
package CDN::Edgecast::Client::auto::MediaManager::Element::LoadFileToEdge;
BEGIN {
  $CDN::Edgecast::Client::auto::MediaManager::Element::LoadFileToEdge::VERSION = '0.01.00';
}
use strict;
use warnings;
...
CDN::Edgecast::Client::auto::MediaManager::Element::LoadFileToEdge
...
=head2 new
 ...
 my $element = CDN::Edgecast::Client::auto::MediaManager::Element::LoadFileToEdge->new($data);
