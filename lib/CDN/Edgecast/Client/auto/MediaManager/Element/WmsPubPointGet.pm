...
package CDN::Edgecast::Client::auto::MediaManager::Element::WmsPubPointGet;
BEGIN {
  $CDN::Edgecast::Client::auto::MediaManager::Element::WmsPubPointGet::VERSION = '0.01.00';
}
use strict;
use warnings;
...
CDN::Edgecast::Client::auto::MediaManager::Element::WmsPubPointGet
...
=head2 new
 ...
 my $element = CDN::Edgecast::Client::auto::MediaManager::Element::WmsPubPointGet->new($data);
