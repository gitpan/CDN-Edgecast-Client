...
package CDN::Edgecast::Client::auto::MediaManager::Element::FmsLiveAuthStreamKeyGet;
BEGIN {
  $CDN::Edgecast::Client::auto::MediaManager::Element::FmsLiveAuthStreamKeyGet::VERSION = '0.01.00';
}
use strict;
use warnings;
...
CDN::Edgecast::Client::auto::MediaManager::Element::FmsLiveAuthStreamKeyGet
...
=head2 new
 ...
 my $element = CDN::Edgecast::Client::auto::MediaManager::Element::FmsLiveAuthStreamKeyGet->new($data);
