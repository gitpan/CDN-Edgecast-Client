...
package CDN::Edgecast::Client::auto::MediaManager::Element::FmsLiveAuthStreamKeyAdd;
BEGIN {
  $CDN::Edgecast::Client::auto::MediaManager::Element::FmsLiveAuthStreamKeyAdd::VERSION = '0.01.00';
}
use strict;
use warnings;
...
CDN::Edgecast::Client::auto::MediaManager::Element::FmsLiveAuthStreamKeyAdd
...
=head2 new
 ...
 my $element = CDN::Edgecast::Client::auto::MediaManager::Element::FmsLiveAuthStreamKeyAdd->new($data);
