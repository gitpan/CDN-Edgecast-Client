...
package CDN::Edgecast::Client::auto::MediaManager::Element::PurgeFileFromEdge;
BEGIN {
  $CDN::Edgecast::Client::auto::MediaManager::Element::PurgeFileFromEdge::VERSION = '0.01.00';
}
use strict;
use warnings;
...
CDN::Edgecast::Client::auto::MediaManager::Element::PurgeFileFromEdge
...
=head2 new
 ...
 my $element = CDN::Edgecast::Client::auto::MediaManager::Element::PurgeFileFromEdge->new($data);
