...
package CDN::Edgecast::Client::auto::MediaManager::Element::FmsLiveAuthStreamKeysGet;
BEGIN {
  $CDN::Edgecast::Client::auto::MediaManager::Element::FmsLiveAuthStreamKeysGet::VERSION = '0.01.00';
}
use strict;
use warnings;
...
CDN::Edgecast::Client::auto::MediaManager::Element::FmsLiveAuthStreamKeysGet
...
=head2 new
 ...
 my $element = CDN::Edgecast::Client::auto::MediaManager::Element::FmsLiveAuthStreamKeysGet->new($data);
