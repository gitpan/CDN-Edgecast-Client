...
package CDN::Edgecast::Client::auto::MediaManager::Element::WmsPubPointMethodsGet;
BEGIN {
  $CDN::Edgecast::Client::auto::MediaManager::Element::WmsPubPointMethodsGet::VERSION = '0.01.00';
}
use strict;
use warnings;
...
CDN::Edgecast::Client::auto::MediaManager::Element::WmsPubPointMethodsGet
...
=head2 new
 ...
 my $element = CDN::Edgecast::Client::auto::MediaManager::Element::WmsPubPointMethodsGet->new($data);
