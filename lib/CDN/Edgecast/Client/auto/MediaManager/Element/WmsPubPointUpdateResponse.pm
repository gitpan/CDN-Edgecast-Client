...
package CDN::Edgecast::Client::auto::MediaManager::Element::WmsPubPointUpdateResponse;
BEGIN {
  $CDN::Edgecast::Client::auto::MediaManager::Element::WmsPubPointUpdateResponse::VERSION = '0.01.00';
}
use strict;
use warnings;
