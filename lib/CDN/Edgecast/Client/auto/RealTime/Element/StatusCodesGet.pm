...
package CDN::Edgecast::Client::auto::RealTime::Element::StatusCodesGet;
BEGIN {
  $CDN::Edgecast::Client::auto::RealTime::Element::StatusCodesGet::VERSION = '0.01.00';
}
use strict;
use warnings;
...
CDN::Edgecast::Client::auto::RealTime::Element::StatusCodesGet
...
=head2 new
 ...
 my $element = CDN::Edgecast::Client::auto::RealTime::Element::StatusCodesGet->new($data);
