...
package CDN::Edgecast::Client::auto::RealTime::Element::StreamsGet;
BEGIN {
  $CDN::Edgecast::Client::auto::RealTime::Element::StreamsGet::VERSION = '0.01.00';
}
use strict;
use warnings;
...
CDN::Edgecast::Client::auto::RealTime::Element::StreamsGet
...
=head2 new
 ...
 my $element = CDN::Edgecast::Client::auto::RealTime::Element::StreamsGet->new($data);
