...
package CDN::Edgecast::Client::auto::RealTime::Element::ConnectionsGet;
BEGIN {
  $CDN::Edgecast::Client::auto::RealTime::Element::ConnectionsGet::VERSION = '0.01.00';
}
use strict;
use warnings;
...
CDN::Edgecast::Client::auto::RealTime::Element::ConnectionsGet
...
=head2 new
 ...
 my $element = CDN::Edgecast::Client::auto::RealTime::Element::ConnectionsGet->new($data);
