...
package CDN::Edgecast::Client::auto::RealTime::Element::CacheStatusesGet;
BEGIN {
  $CDN::Edgecast::Client::auto::RealTime::Element::CacheStatusesGet::VERSION = '0.01.00';
}
use strict;
use warnings;
...
CDN::Edgecast::Client::auto::RealTime::Element::CacheStatusesGet
...
=head2 new
 ...
 my $element = CDN::Edgecast::Client::auto::RealTime::Element::CacheStatusesGet->new($data);
