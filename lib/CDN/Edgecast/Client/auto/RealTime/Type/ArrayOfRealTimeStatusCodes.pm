package CDN::Edgecast::Client::auto::RealTime::Type::ArrayOfRealTimeStatusCodes;
BEGIN {
  $CDN::Edgecast::Client::auto::RealTime::Type::ArrayOfRealTimeStatusCodes::VERSION = '0.01.00';
}
use strict;
use warnings;
