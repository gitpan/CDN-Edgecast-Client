...
package CDN::Edgecast::Client::auto::Administration::Element::OriginShieldPOPsGetResponse;
BEGIN {
  $CDN::Edgecast::Client::auto::Administration::Element::OriginShieldPOPsGetResponse::VERSION = '0.01.00';
}
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'OriginShieldPOPsGetResult' => 'CDN::Edgecast::Client::auto::Administration::Type::ArrayOfShieldPOP',
    },
    {
...
CDN::Edgecast::Client::auto::Administration::Element::OriginShieldPOPsGetResponse
...
=head2 new
 ...
 my $element = CDN::Edgecast::Client::auto::Administration::Element::OriginShieldPOPsGetResponse->new($data);
