...
package CDN::Edgecast::Client::auto::Administration::Element::CustomerGetResponse;
BEGIN {
  $CDN::Edgecast::Client::auto::Administration::Element::CustomerGetResponse::VERSION = '0.01.00';
}
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'CustomerGetResult' => 'CDN::Edgecast::Client::auto::Administration::Type::Customer',
    },
    {
...
CDN::Edgecast::Client::auto::Administration::Element::CustomerGetResponse
...
=head2 new
 ...
 my $element = CDN::Edgecast::Client::auto::Administration::Element::CustomerGetResponse->new($data);
