...
package CDN::Edgecast::Client::auto::Administration::Element::CustomerAccessModuleGet;
BEGIN {
  $CDN::Edgecast::Client::auto::Administration::Element::CustomerAccessModuleGet::VERSION = '0.01.00';
}
use strict;
use warnings;
...
CDN::Edgecast::Client::auto::Administration::Element::CustomerAccessModuleGet
...
=head2 new
 ...
 my $element = CDN::Edgecast::Client::auto::Administration::Element::CustomerAccessModuleGet->new($data);
