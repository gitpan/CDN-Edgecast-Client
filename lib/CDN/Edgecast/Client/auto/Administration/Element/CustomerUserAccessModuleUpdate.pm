...
package CDN::Edgecast::Client::auto::Administration::Element::CustomerUserAccessModuleUpdate;
BEGIN {
  $CDN::Edgecast::Client::auto::Administration::Element::CustomerUserAccessModuleUpdate::VERSION = '0.01.00';
}
use strict;
use warnings;
...
CDN::Edgecast::Client::auto::Administration::Element::CustomerUserAccessModuleUpdate
...
=head2 new
 ...
 my $element = CDN::Edgecast::Client::auto::Administration::Element::CustomerUserAccessModuleUpdate->new($data);
