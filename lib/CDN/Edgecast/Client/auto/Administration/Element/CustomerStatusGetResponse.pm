...
package CDN::Edgecast::Client::auto::Administration::Element::CustomerStatusGetResponse;
BEGIN {
  $CDN::Edgecast::Client::auto::Administration::Element::CustomerStatusGetResponse::VERSION = '0.01.00';
}
use strict;
use warnings;
...
CDN::Edgecast::Client::auto::Administration::Element::CustomerStatusGetResponse
...
=head2 new
 ...
 my $element = CDN::Edgecast::Client::auto::Administration::Element::CustomerStatusGetResponse->new($data);
