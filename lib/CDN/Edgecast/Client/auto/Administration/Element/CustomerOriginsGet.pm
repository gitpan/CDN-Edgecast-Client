...
package CDN::Edgecast::Client::auto::Administration::Element::CustomerOriginsGet;
BEGIN {
  $CDN::Edgecast::Client::auto::Administration::Element::CustomerOriginsGet::VERSION = '0.01.00';
}
use strict;
use warnings;
...
CDN::Edgecast::Client::auto::Administration::Element::CustomerOriginsGet
...
=head2 new
 ...
 my $element = CDN::Edgecast::Client::auto::Administration::Element::CustomerOriginsGet->new($data);
