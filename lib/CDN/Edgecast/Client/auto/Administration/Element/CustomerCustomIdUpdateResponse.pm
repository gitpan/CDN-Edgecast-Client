...
package CDN::Edgecast::Client::auto::Administration::Element::CustomerCustomIdUpdateResponse;
BEGIN {
  $CDN::Edgecast::Client::auto::Administration::Element::CustomerCustomIdUpdateResponse::VERSION = '0.01.00';
}
use strict;
use warnings;
...
CDN::Edgecast::Client::auto::Administration::Element::CustomerCustomIdUpdateResponse
...
=head2 new
 ...
 my $element = CDN::Edgecast::Client::auto::Administration::Element::CustomerCustomIdUpdateResponse->new($data);
