...
package CDN::Edgecast::Client::auto::Administration::Element::CustomerHttpSmallGet;
BEGIN {
  $CDN::Edgecast::Client::auto::Administration::Element::CustomerHttpSmallGet::VERSION = '0.01.00';
}
use strict;
use warnings;
...
CDN::Edgecast::Client::auto::Administration::Element::CustomerHttpSmallGet
...
=head2 new
 ...
 my $element = CDN::Edgecast::Client::auto::Administration::Element::CustomerHttpSmallGet->new($data);
