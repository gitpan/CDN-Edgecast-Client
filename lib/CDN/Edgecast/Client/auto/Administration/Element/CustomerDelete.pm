...
package CDN::Edgecast::Client::auto::Administration::Element::CustomerDelete;
BEGIN {
  $CDN::Edgecast::Client::auto::Administration::Element::CustomerDelete::VERSION = '0.01.00';
}
use strict;
use warnings;
...
CDN::Edgecast::Client::auto::Administration::Element::CustomerDelete
...
=head2 new
 ...
 my $element = CDN::Edgecast::Client::auto::Administration::Element::CustomerDelete->new($data);
