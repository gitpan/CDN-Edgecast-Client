...
package CDN::Edgecast::Client::auto::Administration::Element::CustomerHttpLargeGet;
BEGIN {
  $CDN::Edgecast::Client::auto::Administration::Element::CustomerHttpLargeGet::VERSION = '0.01.00';
}
use strict;
use warnings;
...
CDN::Edgecast::Client::auto::Administration::Element::CustomerHttpLargeGet
...
=head2 new
 ...
 my $element = CDN::Edgecast::Client::auto::Administration::Element::CustomerHttpLargeGet->new($data);
