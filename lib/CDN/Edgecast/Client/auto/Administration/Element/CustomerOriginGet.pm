...
package CDN::Edgecast::Client::auto::Administration::Element::CustomerOriginGet;
BEGIN {
  $CDN::Edgecast::Client::auto::Administration::Element::CustomerOriginGet::VERSION = '0.01.00';
}
use strict;
use warnings;
...
CDN::Edgecast::Client::auto::Administration::Element::CustomerOriginGet
...
=head2 new
 ...
 my $element = CDN::Edgecast::Client::auto::Administration::Element::CustomerOriginGet->new($data);
