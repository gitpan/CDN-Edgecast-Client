...
package CDN::Edgecast::Client::auto::Administration::Element::CustomerAccessModuleUpdate;
BEGIN {
  $CDN::Edgecast::Client::auto::Administration::Element::CustomerAccessModuleUpdate::VERSION = '0.01.00';
}
use strict;
use warnings;
...
CDN::Edgecast::Client::auto::Administration::Element::CustomerAccessModuleUpdate
...
=head2 new
 ...
 my $element = CDN::Edgecast::Client::auto::Administration::Element::CustomerAccessModuleUpdate->new($data);
