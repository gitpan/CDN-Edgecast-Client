...
package CDN::Edgecast::Client::auto::Administration::Element::CustomerHttpLargeUpdate;
BEGIN {
  $CDN::Edgecast::Client::auto::Administration::Element::CustomerHttpLargeUpdate::VERSION = '0.01.00';
}
use strict;
use warnings;
...
CDN::Edgecast::Client::auto::Administration::Element::CustomerHttpLargeUpdate
...
=head2 new
 ...
 my $element = CDN::Edgecast::Client::auto::Administration::Element::CustomerHttpLargeUpdate->new($data);
