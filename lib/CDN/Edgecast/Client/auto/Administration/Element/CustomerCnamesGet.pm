...
package CDN::Edgecast::Client::auto::Administration::Element::CustomerCnamesGet;
BEGIN {
  $CDN::Edgecast::Client::auto::Administration::Element::CustomerCnamesGet::VERSION = '0.01.00';
}
use strict;
use warnings;
...
CDN::Edgecast::Client::auto::Administration::Element::CustomerCnamesGet
...
=head2 new
 ...
 my $element = CDN::Edgecast::Client::auto::Administration::Element::CustomerCnamesGet->new($data);
