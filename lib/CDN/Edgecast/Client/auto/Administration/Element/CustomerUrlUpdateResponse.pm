...
package CDN::Edgecast::Client::auto::Administration::Element::CustomerUrlUpdateResponse;
BEGIN {
  $CDN::Edgecast::Client::auto::Administration::Element::CustomerUrlUpdateResponse::VERSION = '0.01.00';
}
use strict;
use warnings;
...
CDN::Edgecast::Client::auto::Administration::Element::CustomerUrlUpdateResponse
...
=head2 new
 ...
 my $element = CDN::Edgecast::Client::auto::Administration::Element::CustomerUrlUpdateResponse->new($data);
