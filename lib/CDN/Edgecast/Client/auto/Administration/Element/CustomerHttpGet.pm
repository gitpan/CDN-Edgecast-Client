...
package CDN::Edgecast::Client::auto::Administration::Element::CustomerHttpGet;
BEGIN {
  $CDN::Edgecast::Client::auto::Administration::Element::CustomerHttpGet::VERSION = '0.01.00';
}
use strict;
use warnings;
...
CDN::Edgecast::Client::auto::Administration::Element::CustomerHttpGet
...
=head2 new
 ...
 my $element = CDN::Edgecast::Client::auto::Administration::Element::CustomerHttpGet->new($data);
