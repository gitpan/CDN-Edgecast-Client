...
package CDN::Edgecast::Client::auto::Administration::Element::CustomerUsersGet;
BEGIN {
  $CDN::Edgecast::Client::auto::Administration::Element::CustomerUsersGet::VERSION = '0.01.00';
}
use strict;
use warnings;
...
CDN::Edgecast::Client::auto::Administration::Element::CustomerUsersGet
...
=head2 new
 ...
 my $element = CDN::Edgecast::Client::auto::Administration::Element::CustomerUsersGet->new($data);
