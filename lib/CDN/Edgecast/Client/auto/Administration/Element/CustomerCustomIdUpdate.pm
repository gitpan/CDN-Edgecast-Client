...
package CDN::Edgecast::Client::auto::Administration::Element::CustomerCustomIdUpdate;
BEGIN {
  $CDN::Edgecast::Client::auto::Administration::Element::CustomerCustomIdUpdate::VERSION = '0.01.00';
}
use strict;
use warnings;
...
CDN::Edgecast::Client::auto::Administration::Element::CustomerCustomIdUpdate
...
=head2 new
 ...
 my $element = CDN::Edgecast::Client::auto::Administration::Element::CustomerCustomIdUpdate->new($data);
