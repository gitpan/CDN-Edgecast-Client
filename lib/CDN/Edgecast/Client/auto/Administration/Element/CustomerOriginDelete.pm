...
package CDN::Edgecast::Client::auto::Administration::Element::CustomerOriginDelete;
BEGIN {
  $CDN::Edgecast::Client::auto::Administration::Element::CustomerOriginDelete::VERSION = '0.01.00';
}
use strict;
use warnings;
...
CDN::Edgecast::Client::auto::Administration::Element::CustomerOriginDelete
...
=head2 new
 ...
 my $element = CDN::Edgecast::Client::auto::Administration::Element::CustomerOriginDelete->new($data);
