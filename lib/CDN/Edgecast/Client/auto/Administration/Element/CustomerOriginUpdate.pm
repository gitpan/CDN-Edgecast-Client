...
package CDN::Edgecast::Client::auto::Administration::Element::CustomerOriginUpdate;
BEGIN {
  $CDN::Edgecast::Client::auto::Administration::Element::CustomerOriginUpdate::VERSION = '0.01.00';
}
use strict;
use warnings;
...
CDN::Edgecast::Client::auto::Administration::Element::CustomerOriginUpdate
...
=head2 new
 ...
 my $element = CDN::Edgecast::Client::auto::Administration::Element::CustomerOriginUpdate->new($data);
