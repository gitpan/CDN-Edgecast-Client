...
package CDN::Edgecast::Client::auto::Administration::Element::CustomerOriginAdvancedGet;
BEGIN {
  $CDN::Edgecast::Client::auto::Administration::Element::CustomerOriginAdvancedGet::VERSION = '0.01.00';
}
use strict;
use warnings;
...
CDN::Edgecast::Client::auto::Administration::Element::CustomerOriginAdvancedGet
...
=head2 new
 ...
 my $element = CDN::Edgecast::Client::auto::Administration::Element::CustomerOriginAdvancedGet->new($data);
