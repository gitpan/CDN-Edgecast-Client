...
package CDN::Edgecast::Client::auto::Administration::Element::CustomerWmsGet;
BEGIN {
  $CDN::Edgecast::Client::auto::Administration::Element::CustomerWmsGet::VERSION = '0.01.00';
}
use strict;
use warnings;
...
CDN::Edgecast::Client::auto::Administration::Element::CustomerWmsGet
...
=head2 new
 ...
 my $element = CDN::Edgecast::Client::auto::Administration::Element::CustomerWmsGet->new($data);
