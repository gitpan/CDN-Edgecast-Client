...
package CDN::Edgecast::Client::auto::Administration::Element::CustomerHttpSmallUpdate;
BEGIN {
  $CDN::Edgecast::Client::auto::Administration::Element::CustomerHttpSmallUpdate::VERSION = '0.01.00';
}
use strict;
use warnings;
...
CDN::Edgecast::Client::auto::Administration::Element::CustomerHttpSmallUpdate
...
=head2 new
 ...
 my $element = CDN::Edgecast::Client::auto::Administration::Element::CustomerHttpSmallUpdate->new($data);
