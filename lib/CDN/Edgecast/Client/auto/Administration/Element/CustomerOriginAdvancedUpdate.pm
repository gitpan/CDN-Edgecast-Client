...
package CDN::Edgecast::Client::auto::Administration::Element::CustomerOriginAdvancedUpdate;
BEGIN {
  $CDN::Edgecast::Client::auto::Administration::Element::CustomerOriginAdvancedUpdate::VERSION = '0.01.00';
}
use strict;
use warnings;
...
CDN::Edgecast::Client::auto::Administration::Element::CustomerOriginAdvancedUpdate
...
=head2 new
 ...
 my $element = CDN::Edgecast::Client::auto::Administration::Element::CustomerOriginAdvancedUpdate->new($data);
