...
package CDN::Edgecast::Client::auto::Administration::Element::CustomerCnameDelete;
BEGIN {
  $CDN::Edgecast::Client::auto::Administration::Element::CustomerCnameDelete::VERSION = '0.01.00';
}
use strict;
use warnings;
...
CDN::Edgecast::Client::auto::Administration::Element::CustomerCnameDelete
...
=head2 new
 ...
 my $element = CDN::Edgecast::Client::auto::Administration::Element::CustomerCnameDelete->new($data);
