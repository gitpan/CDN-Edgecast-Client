...
package CDN::Edgecast::Client::auto::Administration::Element::CustomerStatusGet;
BEGIN {
  $CDN::Edgecast::Client::auto::Administration::Element::CustomerStatusGet::VERSION = '0.01.00';
}
use strict;
use warnings;
...
CDN::Edgecast::Client::auto::Administration::Element::CustomerStatusGet
...
=head2 new
 ...
 my $element = CDN::Edgecast::Client::auto::Administration::Element::CustomerStatusGet->new($data);
