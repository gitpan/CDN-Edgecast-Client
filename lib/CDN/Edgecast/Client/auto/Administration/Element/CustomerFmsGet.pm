...
package CDN::Edgecast::Client::auto::Administration::Element::CustomerFmsGet;
BEGIN {
  $CDN::Edgecast::Client::auto::Administration::Element::CustomerFmsGet::VERSION = '0.01.00';
}
use strict;
use warnings;
...
CDN::Edgecast::Client::auto::Administration::Element::CustomerFmsGet
...
=head2 new
 ...
 my $element = CDN::Edgecast::Client::auto::Administration::Element::CustomerFmsGet->new($data);
