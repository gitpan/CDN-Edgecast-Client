...
package CDN::Edgecast::Client::auto::Administration::Element::CustomerWmsUpdate;
BEGIN {
  $CDN::Edgecast::Client::auto::Administration::Element::CustomerWmsUpdate::VERSION = '0.01.00';
}
use strict;
use warnings;
...
CDN::Edgecast::Client::auto::Administration::Element::CustomerWmsUpdate
...
=head2 new
 ...
 my $element = CDN::Edgecast::Client::auto::Administration::Element::CustomerWmsUpdate->new($data);
