...
package CDN::Edgecast::Client::auto::Administration::Element::OriginShieldPOPsGet;
BEGIN {
  $CDN::Edgecast::Client::auto::Administration::Element::OriginShieldPOPsGet::VERSION = '0.01.00';
}
use strict;
use warnings;
...
CDN::Edgecast::Client::auto::Administration::Element::OriginShieldPOPsGet
...
=head2 new
 ...
 my $element = CDN::Edgecast::Client::auto::Administration::Element::OriginShieldPOPsGet->new($data);
