...
package CDN::Edgecast::Client::auto::Administration::Element::CustomerOriginAdd;
BEGIN {
  $CDN::Edgecast::Client::auto::Administration::Element::CustomerOriginAdd::VERSION = '0.01.00';
}
use strict;
use warnings;
...
CDN::Edgecast::Client::auto::Administration::Element::CustomerOriginAdd
...
=head2 new
 ...
 my $element = CDN::Edgecast::Client::auto::Administration::Element::CustomerOriginAdd->new($data);
