...
package CDN::Edgecast::Client::auto::Administration::Element::CustomerUserGet;
BEGIN {
  $CDN::Edgecast::Client::auto::Administration::Element::CustomerUserGet::VERSION = '0.01.00';
}
use strict;
use warnings;
...
CDN::Edgecast::Client::auto::Administration::Element::CustomerUserGet
...
=head2 new
 ...
 my $element = CDN::Edgecast::Client::auto::Administration::Element::CustomerUserGet->new($data);
