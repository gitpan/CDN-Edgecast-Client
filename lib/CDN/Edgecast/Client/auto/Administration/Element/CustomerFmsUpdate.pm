...
package CDN::Edgecast::Client::auto::Administration::Element::CustomerFmsUpdate;
BEGIN {
  $CDN::Edgecast::Client::auto::Administration::Element::CustomerFmsUpdate::VERSION = '0.01.00';
}
use strict;
use warnings;
...
CDN::Edgecast::Client::auto::Administration::Element::CustomerFmsUpdate
...
=head2 new
 ...
 my $element = CDN::Edgecast::Client::auto::Administration::Element::CustomerFmsUpdate->new($data);
