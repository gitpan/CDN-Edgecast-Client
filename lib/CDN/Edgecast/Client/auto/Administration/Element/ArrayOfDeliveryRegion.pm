...
package CDN::Edgecast::Client::auto::Administration::Element::ArrayOfDeliveryRegion;
BEGIN {
  $CDN::Edgecast::Client::auto::Administration::Element::ArrayOfDeliveryRegion::VERSION = '0.01.00';
}
use strict;
use warnings;
