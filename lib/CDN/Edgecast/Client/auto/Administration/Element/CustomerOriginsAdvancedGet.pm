...
package CDN::Edgecast::Client::auto::Administration::Element::CustomerOriginsAdvancedGet;
BEGIN {
  $CDN::Edgecast::Client::auto::Administration::Element::CustomerOriginsAdvancedGet::VERSION = '0.01.00';
}
use strict;
use warnings;
...
CDN::Edgecast::Client::auto::Administration::Element::CustomerOriginsAdvancedGet
...
=head2 new
 ...
 my $element = CDN::Edgecast::Client::auto::Administration::Element::CustomerOriginsAdvancedGet->new($data);
