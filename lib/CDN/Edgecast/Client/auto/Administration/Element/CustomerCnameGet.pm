...
package CDN::Edgecast::Client::auto::Administration::Element::CustomerCnameGet;
BEGIN {
  $CDN::Edgecast::Client::auto::Administration::Element::CustomerCnameGet::VERSION = '0.01.00';
}
use strict;
use warnings;
...
CDN::Edgecast::Client::auto::Administration::Element::CustomerCnameGet
...
=head2 new
 ...
 my $element = CDN::Edgecast::Client::auto::Administration::Element::CustomerCnameGet->new($data);
