...
package CDN::Edgecast::Client::auto::Administration::Element::CustomerServiceUpdateResponse;
BEGIN {
  $CDN::Edgecast::Client::auto::Administration::Element::CustomerServiceUpdateResponse::VERSION = '0.01.00';
}
use strict;
use warnings;
...
CDN::Edgecast::Client::auto::Administration::Element::CustomerServiceUpdateResponse
...
=head2 new
 ...
 my $element = CDN::Edgecast::Client::auto::Administration::Element::CustomerServiceUpdateResponse->new($data);
